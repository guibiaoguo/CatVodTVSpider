...
public class Kunyu78 extends Spider {
    ...
    private HashMap<String, String> K(String str) {
        ...
        hashMap.put("TK","d66b2f9594d181b4bff376d69987801b");
    ...
    public String detailContent(List<String> list) {
        try {
            String str = "http://api.kunyu77.com/api.php/provide/videoDetail?ids=" + list.get(0) + "&version=2.0.4&sj=1684420100";
            ...
            String str2 = "http://api.kunyu77.com/api.php/provide/videoPlaylist?ids=" + list.get(0)+ "&version=2.0.4&sj=1684420100";
            HashMap t = K(str2);
            t.put("TK","ab9055ee420340e2b6e0f02a6498e89a");
            JSONArray jSONArray2 = new JSONObject(OkHttpUtil.string(str2, t)).optJSONObject("data").optJSONArray("episodes");
