...
public class If101 extends Spider {
    ...
    public void init(Context context) {
        super.init(context);
        try {
            playerConfig = new JSONObject("{\"if101\":{\"sh\":\"蓝光\",\"sn\":0,\"pu\":\"\",\"or\":999}}");
    ...
    public String homeVideoContent() throws Exception {
        ...
        Document doc = Jsoup.parse(OkHttpUtil.string(siteUrl, getHeaders(siteUrl)));
        Element homeList = doc.select("ul.hl-vod-list").get(0);
        Elements elements = homeList.select("li.hl-list-item");
        JSONArray videos = new JSONArray();
    ...
    public String detailContent(List<String> ids) {
        try {
            ...
            Elements sourceList = doc.select(".hl-plays-list");
        ...
        try {
            ...
            if (searchResult.getInt("total") > 0) {
                ...
                for (int i = 0; i < lists.length(); i++) {
                    ...
                    String remark = vod.optString("en");
