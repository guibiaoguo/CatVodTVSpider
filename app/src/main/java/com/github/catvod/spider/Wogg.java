 ...
 * @author zhixc
 */
public class Wogg extends NetworkDrive {
    private final String TAG = Wogg.class.getSimpleName();
    ...
    public String homeContent(boolean filter) {
        ...
        return Result.string(classes, parseVodListFromDoc(doc), filter ? JsonParser.parseString (filterConfig) : null);
    }
    ...
    public String detailContent(List<String> ids) throws Exception {
        ...
        String content = OkHttpUtil.string(siteUrl + vodId, getHeader());
        Document doc = Jsoup.parse (content);
        Vod item = new Vod();
        item.setVodId(vodId);
        item.setVodName(doc.select(".video-info-header > .page-title").text());
        item.setVodPic(doc.select(".module-item-pic img").attr("data-src"));
