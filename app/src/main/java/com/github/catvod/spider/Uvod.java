...
public class Uvod extends Spider {
    ...
    private static String siteHost = "uvod.tv";
    ...
    public void init(Context context, String extend) {
        JsonObject jsonObject = Json.safeObject(extend);
        OkHttp.get().setProxy(jsonObject.get("proxy").getAsString());
        if (jsonObject.has("host")){
            siteUrl = jsonObject.get("proxy").getAsString();
            siteHost = NetworkUtils.INSTANCE.getSubDomain(siteUrl);
        }
        OkHttp.selector().setHosts(Arrays.asList(siteHost));
    }
    ...
    public String homeContent(boolean filter) throws Exception {
        ...
        String content = OkHttp.postJson(latest, encryptData, getHeader(latest));
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) throws Exception {
        ...
        String encryptData = encrypt(param);
        String content = OkHttp.postJson(list, encryptData, getHeader(list + "|" + tid + "|" + pg));
        String decryptData = decrypt(content);
        Data data = Data.objectFrom(decryptData);
    ...
    public String detailContent(List<String> ids) throws Exception {
        ...
        String encryptData = encrypt(param);
        String content = OkHttp.postJson(detail, encryptData, getHeader(detail + "|" + ids.get(0)));
        String decryptData = decrypt(content);
        Data data = Data.objectFrom(decryptData);
    ...
    public String searchContent(String key, boolean quick) throws Exception {
        ...
        String encryptData = encrypt(param);
        String content = OkHttp.postJson(list, encryptData, getHeader(list + "|" + key));
        String decryptData = decrypt(content);
        Data data = Data.objectFrom(decryptData);
        return Result.string(data.getList());
    }
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) throws Exception {
        ...
        for (String s : quality) {
            ...
            String encryptData = encrypt(param);
            String content = OkHttp.postJson(play, encryptData, getHeader(play + "|" + tid + "|" + nid + "|" + s.trim()));
            String decryptData = decrypt(content);
            Data data = Data.objectFrom(decryptData);
