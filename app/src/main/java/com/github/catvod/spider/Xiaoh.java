...
//                String sourceName = sourcess.select("h3").text();
//                String list1 = sourcess.attr("href");
//                Matcher matcher = regexVid.matcher(list1);
//                if (sourceName.contains(key) && matcher.find()) {
//                    Document ddrklink = Jsoup.parse(OkHttpUtil.string(list1, getHeaders(list1)));
//                    JSONObject v = new JSONObject();
//                    String group = matcher.group(1);
//                    String cover = ddrklink.selectFirst("a.myui-vodlist__thumb img").attr("data-original");
//                    String title = ddrklink.selectFirst("div.myui-content__detail h1.title").text();
//                    Elements span_text_muted = ddrklink.select("div.myui-content__detail span.text-muted");
//                    for (int j = 0; j < span_text_muted.size(); j++) {
//                        Element text = span_text_muted.get(j);
//                        String info = text.text();
//                        if (info.equals("更新：")) {
//                            String remark = text.nextElementSibling().text();
//                            v.put("vod_name", title);
//                            v.put("vod_remarks", remark);
//                            v.put("vod_id", group);
//                            v.put("vod_pic", cover);
