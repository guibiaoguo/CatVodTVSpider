...
public class Kanqiu extends Spider {
    ...
    private String siteUrl = "http://www.88kanqiu.me";
    private String siteHost = "www.88kanqiu.me";
...
//            setSiteUrl(extend);
    ...
    public String homeVideoContent() throws Exception {
        return categoryContent("","1",false, new HashMap<>());
    }
