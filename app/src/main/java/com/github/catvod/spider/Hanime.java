...
public class Hanime extends Spider {
    ...
    private static final String siteHost = "hanime1.me";
    @Override
    ...
    public String homeContent(boolean filter) throws Exception {
        ...
        Elements yearElements = doc1.getElementById("year").select("option");
        List<String> years = yearElements != null ?yearElements.eachAttr("value"):new ArrayList<>();
    ...
    public String searchContent(String key, boolean quick) throws Exception {
        ...
        for (Element element : doc.select("div.col-xs-6")) {
            ...
            String url = element.select("a.overlay").attr("href");
            String name = element.select("div.card-mobile-title").text();
            String id = url.indexOf("=")>-1?url.split("=")[1]:"";
            list.add(new Vod(id, name, pic));
        }
        return Result.string(list);
    }
