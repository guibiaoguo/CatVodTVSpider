...
public class LiteApple1 extends Spider {
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> hashMap) {
        try {
            String str3 = "http://ht.grelighting.cn/api.php/v2.vod/androidfilter?page=" + str2 + "&type=" + str;
            ...
            JSONArray jSONArray = new JSONObject(OkHttpUtil.string(str3, zM(str3))).optJSONArray("data");
    ...
    public String detailContent(List<String> list) {
        try {
            ...
            sb.append("http://ht.grelighting.cn/api.php/v2.vod/androiddetail?vod_id=");
            sb.append(list.get(0));
            String sb2 = sb.toString();
            JSONObject jSONObject = new JSONObject(OkHttpUtil.string(sb2, zM(sb2))).optJSONObject("data");
            JSONObject jSONObject2 = new JSONObject();
    ...
    public String homeContent(boolean z) {
        ...
        try {
            JSONArray jSONArray = new JSONObject(OkHttpUtil.string("http://app.grelighting.cn/api.php/v1.vod/androidtypes", zM("http://app.grelighting.cn/api.php/v1.vod/androidtypes"))).optJSONArray("data");
    ...
    public String homeVideoContent() {
        try {
            ...
            for (int i = 1; i < 5; i++) {
                try {
                    JSONArray jSONArray2 = new JSONObject(OkHttpUtil.string("http://app.grelighting.cn/api.php/v1.main/androidhome", zM("http://app.grelighting.cn/api.php/v1.main/androidhome"))).optJSONObject("data").optJSONArray("list");
    ...
    public String searchContent(String str, boolean z) {
        try {
            ...
            JSONArray jSONArray = new JSONObject(OkHttpUtil.string(str2, zM(str2))).optJSONArray("data");
            JSONArray jSONArray2 = new JSONArray();
            for (int i = 0; i < jSONArray.length(); i++) {
                JSONObject jSONObject = jSONArray.optJSONObject(i);
