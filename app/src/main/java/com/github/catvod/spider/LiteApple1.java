...
//            for (int i = 1; i < 5; i++) {
//                try {
//                    JSONArray jSONArray2 = new JSONObject(OkHttpUtil.string("http://ht.grelighting.cn/api.php/v1.main/androidhome", zM("http://app.grelighting.cn/api.php/v1.main/androidhome"))).optJSONObject("data").optJSONArray("list");
