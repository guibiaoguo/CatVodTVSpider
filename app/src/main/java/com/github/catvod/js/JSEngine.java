...
//                @Override
//                public Object call(Object... args) {
//                    SharedPreferences sharedPreferences = Init.context().getSharedPreferences("js_engine_" + args[0].toString(), Context.MODE_PRIVATE);
...
//                        if (redirect == 1) {
//                            client = OkHttpUtil.defaultClient();
//                        } else {
//                            client = OkHttpUtil.noRedirectClient();
//                        }
