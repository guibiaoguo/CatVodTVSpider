...
public class QuarkTest {
    ...
    public void init() {
        ...
        quark.init(null,"{\n" +
                ...
                "        {\n" +
                "            \"type_name\":\"经典剧集\",\n" +
                "            \"type_id\":\"https://pan.quark.cn/s/047991d5955e/e8ea50e04bb3480db0f1ee9f3155d49b\",\n" +
                "            \"type_flag\":\"1\"\n" +
                "        },\n" +
                "        {\n" +
                "            \"type_name\":\"短剧162g\",\n" +
                "            \"type_id\":\"https://pan.quark.cn/s/432b5cd3a225\"\n" +
                "        }\n" +
                "    ]\n" +
                "}");
    }
    ...
    public void homeVideoContent() throws Exception {
        System.out.println(quark.homeContent(false));
        System.out.println(quark.homeVideoContent());
    }

    @Test
    public void categoryContent() throws Exception {
        String content = quark.homeContent(false);
        System.out.println(content);
        Result result = new Gson().fromJson(content, Result.class);
        content = quark.categoryContent(result.getClasses().get(0).getTypeId(),"1",false,new HashMap<>());
        System.out.println(content);
        result = new Gson().fromJson(content, Result.class);
        Assert.assertTrue(result.getList().size() > 0);
        System.out.println(quark.categoryContent("https://pan.quark.cn/s/047991d5955e/3e6f2620ad1e4b0fa18ee51b307dbef8#","1",false,new HashMap<>()));
    }
    ...
    public void detailContent() throws Exception {
        ...
        content = quark.detailContent(Arrays.asList("https://pan.quark.cn/s/58edc8a9951e"));
        System.out.println(content);
    }
    ...
    public void playerContent() throws Exception {
        ...
        String id = result.getList().get(3).getVodId();
        ...
        System.out.println(id);
//        System.out.println(quark.playerContent("夸克雲盤原畫", id, null));
        System.out.println(quark.playerContent("高清", id, null));

        content = quark.detailContent(Arrays.asList("https://pan.quark.cn/s/047991d5955e/a8e14dc344e94e9c93c1e6b5cd80ac8b"));
        result = new Gson().fromJson(content, Result.class);
        id = result.getList().get(0).getVodPlayUrl().split("#")[0].split("\\$")[1];
        content = quark.playerContent("原畫", id, null);
        System.out.println(content);
        JsonObject object = Json.safeObject(content);
        System.out.println(OkHttp.string(object.getAsJsonArray("subs").get(0).getAsJsonObject().get("url").getAsString()));
//        System.out.println(quark.playerContent("高清", id, null));
    }
}
