...
//        });
    ...
    public void categoryContent() throws Exception {
        String content = wogg.homeContent(false);
        System.out.println(content);
        Result result = new Gson().fromJson(content, Result.class);
        content = wogg.categoryContent(result.getClasses().get(0).getTypeId(),"1",false,new HashMap<>());
        System.out.println(content);
    ...
    public void detailContent() throws Exception {
        System.out.println(wogg.detailContent(Arrays.asList("/voddetail/90168.html")));
        String content = wogg.homeContent(true);
        System.out.println(content);
        Result result = new Gson().fromJson(content, Result.class);
        if (result.getList().isEmpty()) {
            content = wogg.homeVideoContent();
            result = new Gson().fromJson(content, Result.class);
        }
        String id = result.getList().get(1).getVodId();
        content = wogg.detailContent(Arrays.asList(id));
        System.out.println(content);
        result = new Gson().fromJson(content, Result.class);
        Assert.assertTrue(result.getList().size() > 0);
    ...
    public void playerContent() throws Exception {
        ...
        System.out.println(wogg.playerContent("原畫", id, null));
    }
